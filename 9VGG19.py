...
model.add(layers.Dense(4096, activation='relu', name='vgg19fc1'))
model.add(layers.Dropout(0.5))
model.add(layers.Dense(4096, activation='relu', name='vgg19fc2'))
model.add(layers.Dropout(0.5))
...
model_filepath='./weight/pigCoughThermalv2Cnn/Vgg19.cnn.cqt.best.h5'
