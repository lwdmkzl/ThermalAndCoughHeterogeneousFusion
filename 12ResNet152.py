...
conv_base = ResNet(input_shape=(100, 100, 3), nclass=2, net_name='resnet152')

model = models.Sequential()
model.add(conv_base)

model.add(layers.Dense(256, activation='relu', name='resnet152fc1'))
...
model_filepath='./weight/pigCoughThermalv2Cnn/ResNet152.cnn.cqt.best.h5'
