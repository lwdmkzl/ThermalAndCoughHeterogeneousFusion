...
df_all_pd = pd.concat([df_1_pd, df_2_pd, df_3_pd], axis=1, join='outer')

x_train_LayerFusion_Acoustic, x_test_LayerFusion_Acoustic, y_train_LayerFusion_Acoustic, y_test_LayerFusion_Acoustic = train_test_split(df_all_pd, labels, test_size=0.3)

dt = SVC()

dt.fit(df_all_pd, labels)
joblib.dump(dt, svm_model_baseDir+'lab3_fc1_fc2_acous.pkl')