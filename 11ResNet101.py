...
conv_base = ResNet(input_shape=(100, 100, 3), nclass=2, net_name='resnet101')

model = models.Sequential()
model.add(conv_base)

model.add(layers.Dense(256, activation='relu', name='resnet101fc1'))
...
model_filepath='./weight/pigCoughThermalv2Cnn/ResNet101.cnn.cqt.best.h5'
