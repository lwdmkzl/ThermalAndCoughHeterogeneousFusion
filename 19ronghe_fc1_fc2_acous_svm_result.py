...
dt = joblib.load(svm_model_baseDir+'lab3_fc1_fc2_acous.pkl')
...
print("召回率指标:", _recall)
print("f1得分指标:", _f1)
np.save('weight/pigCoughThermalv2Cnn/lab_ronghe_lab4.npy', [round(_accuracy*100,2),round(_precision*100,2),round(_recall*100,2),round(_f1*100,2)])