...
dt = joblib.load(svm_model_baseDir+'lab3_fc1_acous.pkl')
print("交叉验证:")
...
print("召回率指标:", _recall)
print("f1得分指标:", _f1)
np.save('weight/pigCoughThermalv2Cnn/lab_ronghe_lab5.npy', [round(_accuracy*100,2),round(_precision*100,2),round(_recall*100,2),round(_f1*100,2)])